# set(TEMP_BC_DIR ${CMAKE_BINARY_DIR}/temp)
...
foreach(LLVM_BC_EXE ${LLVM_BC_C_COMPILER} ${LLVM_BC_CXX_COMPILER} ${LLVM_BC_AR} ${LLVM_BC_RANLIB} ${LLVM_BC_LINK} ${LLVM_BC_ANALYZER} ${LLVM_BC_OPT})
