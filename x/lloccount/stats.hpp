...
void Stats::Init(std::map<int, Stats *> &stats) {
  ...
  stats[CXCursor_StructDecl]->category = Ty_Declaration;
  stats[CXCursor_UnionDecl] = new Stats("union");
  stats[CXCursor_UnionDecl]->category = Ty_Declaration;
  stats[CXCursor_ClassDecl] = new Stats("class");
  stats[CXCursor_ClassDecl]->category = Ty_Declaration;
  stats[CXCursor_EnumDecl] = new Stats("enum");
  stats[CXCursor_EnumDecl]->category = Ty_Declaration;

  stats[CXCursor_IfStmt] = new Stats("if");
  stats[CXCursor_IfStmt]->category = Ty_Condition;
  stats[CXCursor_SwitchStmt] = new Stats("switch");
  stats[CXCursor_SwitchStmt]->category = Ty_Condition;
  stats[CXCursor_WhileStmt] = new Stats("while");
  stats[CXCursor_WhileStmt]->category = Ty_Loop;
  stats[CXCursor_DoStmt] = new Stats("do");
  stats[CXCursor_DoStmt]->category = Ty_Loop;
  stats[CXCursor_ForStmt] = new Stats("for");
  stats[CXCursor_ForStmt]->category = Ty_Loop;

  stats[CXCursor_GotoStmt] = new Stats("goto");
  stats[CXCursor_GotoStmt]->category = Ty_Statement;
  stats[CXCursor_BreakStmt] = new Stats("break");
  stats[CXCursor_BreakStmt]->category = Ty_Statement;
  stats[CXCursor_ReturnStmt] = new Stats("return");
  stats[CXCursor_ReturnStmt]->category = Ty_Statement;

  stats[CXCursor_InclusionDirective] = new Stats("include");
  stats[CXCursor_InclusionDirective]->category = Ty_Statement;
  stats[CXCursor_CallExpr] = new Stats("function call");
  stats[CXCursor_CallExpr]->category = Ty_Call;
  stats[CXCursor_FunctionDecl] = new Stats("functions");
  stats[CXCursor_FunctionDecl]->category = Ty_Function;
  stats[CXCursor_VarDecl] = new Stats("variable");
  stats[CXCursor_VarDecl]->category = Ty_Statement;
  ...
  stats[CXCursor_ObjCInstanceMethodDecl] =
      new Stats("ObjCInstanceMethod Declaration");
  stats[CXCursor_ObjCClassMethodDecl] =
      new Stats("ObjCClassMethod Declaration");
  stats[CXCursor_ObjCImplementationDecl] =
      new Stats("ObjCImplementation Declaration");
  stats[CXCursor_ObjCCategoryImplDecl] =
      new Stats("ObjCCategoryImpl Declaration");
  ...
  stats[CXCursor_NonTypeTemplateParameter] =
      new Stats("NonTypeTemplateParameter");
  stats[CXCursor_TemplateTemplateParameter] =
      new Stats("TemplateTemplateParameter");
  stats[CXCursor_FunctionTemplate] = new Stats("FunctionTemplate");
  stats[CXCursor_ClassTemplate] = new Stats("ClassTemplate");
  stats[CXCursor_ClassTemplatePartialSpecialization] =
      new Stats("ClassTemplatePartialSpecialization");
  ...
  stats[CXCursor_ObjCAutoreleasePoolStmt] =
      new Stats("ObjCAutoreleasePoolStmt");
  ...
  stats[Ty_Misc] = new Stats("Misc");
  stats[Ty_Declaration] = new Stats("Declarations");
  stats[Ty_Statement] = new Stats("Statements");
  stats[Ty_Loop] = new Stats("Loops");
  stats[Ty_Condition] = new Stats("Conditions");
  stats[Ty_Function] = new Stats("Functions");
  stats[Ty_Call] = new Stats("Calls");
}
